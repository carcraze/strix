            ...
            <style>{`
                @media print {
                    ...
                    * {
                    ...
                    .print-footer::after {
                        content: "Generated by Zentinel · zentinel.dev";
                    ...
                    <div className="max-w-4xl mx-auto flex items-center justify-between">
                        <a href="https://zentinel.dev" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                            ...
                            <div className="hidden sm:block">
                                ...
                                <div className="text-blue-400/70 text-[10px] font-mono">Security Intelligence Platform</div>
                            </div>
                        </a>
                ...
                <div className="max-w-4xl mx-auto px-6 py-10 space-y-6">
                            ...
                            <div className="flex items-start justify-between gap-6 flex-wrap">
                                <div>
                                    <div className="text-white/40 text-[10px] font-mono uppercase tracking-[0.2em] mb-2">
                                        Security Assessment Report · Zentinel
                                    </div>
                    ...
                    <div className="print-footer flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-6 pb-4 border-t border-white/8">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-white/70 font-semibold text-sm print:text-gray-700">Zentinel Security Platform</div>
                                <div className="text-white/30 text-xs font-mono print:text-gray-400">AI-powered penetration testing · zentinel.dev</div>
                            </div>
                        </div>
