        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto p-6 space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Ignored Issues</h1>
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                    <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-200">
                        <div className="relative flex-1 min-w-[200px]">
                            ...
                            <input
                                ...
                                placeholder="Search ignored issues"
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-24 text-center">
                            <EyeOff className="h-10 w-10 text-gray-300 mb-4" />
                            <h3 className="text-sm font-medium text-gray-600 mb-1">No ignored issues</h3>
                            <p className="text-xs text-gray-500">Issues you ignore will appear here</p>
                        </div>
                    ) : (
                                    ...
                                    {filteredIssues.map(issue => {
                                        ...
                                        return (
                                            <tr key={issue.id} className="hover:bg-gray-50 transition-colors cursor-pointer" onClick={() => setSidebarId(issue.id)}>
                                                ...
                                                <td className="px-5 py-4">
                                                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-gray-700 bg-gray-100 border border-gray-200">
                                                        <EyeOff className="h-3.5 w-3.5" /> Ignored
                                                    </span>
                                                </td>
                                            </tr>
                                        );
